          ...
          <div class='flex flex-wrap justify-between mb-8 md:mb-16'>
            <div class='w-full lg:w-1/3 flex flex-col justify-center lg:pt-48 lg:pb-24 mb-6 sm:mb-12 lg:mb-0'>
              ...
              <p class='max-w-md text-gray-500 xl:text-lg leading-relaxed'>
                Store is a premium e-commerce template with a huge collection of
                modern designs.
              </p>
            </div>
        ...
        <div class='max-w-screen-2xl px-4 md:px-8 mx-auto'>
          <div class='mb-10 md:mb-16'>
            ...
            <p class='max-w-screen-md text-gray-500 md:text-lg text-center mx-auto'>
              All About the Store is a collection of curated articles and
              resources that are relevant to the store.
            </p>
          </div>
        ...
        <div class='max-w-screen-2xl px-4 md:px-8 mx-auto'>
          <div class='flex flex-col lg:flex-row lg:justify-between items-center bg-gray-100 rounded-lg p-4 sm:p-8'>
            <div class='mb-4 sm:mb-8 lg:mb-0'>
              <h2 class='text-indigo-500 text-xl sm:text-2xl lg:text-3xl font-bold text-center lg:text-left'>
      ...
      <div class='bg-white pt-4 sm:pt-10 lg:pt-12'>
        <footer class='max-w-screen-2xl px-4 md:px-8 mx-auto'>
          ...
          <div class='text-gray-400 text-sm text-center border-t py-8'>
            © 2022 - Present Ismaill Mnifl ❤️ and Youcode. All rights reserved.
          </div>
        </footer>
      </div>
    </>
